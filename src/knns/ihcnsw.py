...
class IterativeHCNSW(HNSW):
    def __init__(self, m=5, m_max0='auto', ef_construction=30, mL='auto', ef=30, max_clusters=1024, max_iterations=inf, cluster_exploration_limit=inf) -> None:
        ...
        self.cluster_exploration_limit = cluster_exploration_limit
    ...
    def search(self, query, k=1):
        ...
        self.i = 0
        while len(explored_clusters) < self.cluster_exploration_limit and not self.equal_lists(result, previous_result) and self.i < self.max_iterations:
